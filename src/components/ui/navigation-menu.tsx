...
>(({ className, ...props }, ref) => (
  <div className={cn("top-full left-0 absolute flex justify-center")}>
    <NavigationMenuPrimitive.Viewport
      className={cn(
        "relative bg-popover shadow-lg mt-1.5 border rounded-md w-full md:w-[var(--radix-navigation-menu-viewport-width)] h-[var(--radix-navigation-menu-viewport-height)] overflow-hidden text-popover-foreground origin-top-center data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90",
        className
      )}
      ref={ref}
      {...props}
