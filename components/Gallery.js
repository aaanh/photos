  ...
  return (
    <div className='p-4 flex flex-col mx-12 sm:mx-32'>
      ...
      <div className='columns-1 sm:columns-2 md:columns-3'>
        {
          data?.map((image, idx) => (
            <div key={idx} className="group relative mb-4 hover:z-50 hover:scale-150 transition-transform ease-in-out duration-50 hover:shadow-[-3px_5px_15px_5px_rgba(0,0,0,0.8)]">
              <img src={image.url} className="w-full rounded-md"></img>
